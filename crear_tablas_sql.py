...
instruccion_create = '''CREATE TABLE [Simulaciones_2020].[dbo].[''' + nombre_tabla + '''] (ID_Escenario INT, Bus_Number INT, Bus_Name TEXT, ID_Generador TEXT, P_MW_simulacion FLOAT);'''
cursor.execute(instruccion_create)
conn.commit()
...
nombre_tabla_info = "OUTPUT_AMPS_P_Q_LAT_132"
instruccion_create = '''CREATE TABLE ''' + nombre_tabla_info + ''' (ID_Escenario INT, From_Bus_Number INT, To_Bus_Number INT, AMPS FLOAT, P_MW FLOAT, Q_MVAR FLOAT);'''
#cursor.execute(instruccion_create)
print(instruccion_create)
...
instruccion_create = '''CREATE TABLE ''' + nombre_tabla_info + ''' (ID_Escenario INT, Bus_Number INT, KV FLOAT);'''
#cursor.execute(instruccion_create)
print(instruccion_create)
